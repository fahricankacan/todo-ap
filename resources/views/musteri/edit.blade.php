    ...
    <form action="/musteri/{{ $musteri->id }}" method="post">
        ...
        <fieldset class="mb-3">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" name="adi" value="{{ $musteri->ad }}">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" name="soyad" value="{{ $musteri->soyad }}">
                </div>
            </div>
            ...
            <div class="form-group row">
				<label class="col-form-label col-md-2">Telefon Numarası</label>
					<div class="col-md-10">
							<input class="form-control" type="number" name="telefon_numarasi" value="{{ intval($musteri->tel_no)}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-10">
                    <input class="form-control" type="email" name="email" value="{{ $musteri->mail_adresi}}">
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" name="il" value="{{ $musteri->il}}">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-10">
                    <input type="text" class="form-control" name="ilce" value="{{ $musteri->ilce }}">
                </div>
            </div>
