            ...
            <div class="card-body">
                ...
                <fieldset class="mb-3">
                    ...
                    <div class="form-group row">
                        <label class="col-form-label col-lg-2" for="custom_mail_id">Mail Adresi Gir</label>
                        <div class="col-lg-10">
                            <input type="email" id="custom_mail_id" placeholder="Email" name="mail_adi[]" multiple="multiple">
